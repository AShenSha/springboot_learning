package com.shensha.springbootcrawler.entity;
...
//    @CssSelector(selector = " main > div.blog-content-box > div.article-header-box > div.article-header > div.article-info-box > div > span.date", dateFormat = "yyyy年MM月dd日 HH:mm:ss")
